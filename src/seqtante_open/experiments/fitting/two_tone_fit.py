...
# Keys of :attr:`FluxoniumTwoToneModel.quadratures` and ``.results``, and how each is labelled in the plot.
_QUADRATURE_LABELS = {
...
class FluxoniumTwoToneModel(FittingClass):
    """Fit and plot a two-tone (qubit spectroscopy) frequency sweep.
    ...
    Args:
        ...
        lo: Drive LO in Hz, used to report the absolute drive frequency; if
    ...
    def __init__(
        ...
        self.drive_bus = freq_coord.attrs["bus"]
    ...
    def plot(self):
        ...
        subplot_titles = [
            ...
            f"f_drive = {(self.results[quadrature]['fitted_if'] + lo) * 1e-9:.4f} GHz, "
